...
This course covers elements of data management, descriptive statistics,  and inferential statistics. The course also examines the variance-bias tradeoff, linear regression with K- nearest neighbors, classification including logistic regression and linear discriminant analysis, cross-validation, bootstrapping, subset selection, ridge and lasso regression, and choosing optimal models. 
